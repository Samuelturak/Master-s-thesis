...
cfgOQPSK.PSDULength = 63; 

Fs = 4e+06; 								 % Specify the sample rate of the waveform in Hz
...
for j = AWGNs
    ...
    for i = 1:numPackets
        ...
        %histogram(abs(downsampled_Waveform),50)
    ...
    %constel(waveform(sps/2+1 : desired_Length-sps/2));
    ...
    filename = sprintf('ZIGBEE/Zigbee_%ddB',j);
